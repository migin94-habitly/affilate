export default {
  ...
  auth: {
    ...
    phone: 'Телефон',
    segment: 'Серіктес түрі',
    segments: {
      influencer: 'Блогер / Инфлюенсер',
      ugc: 'UGC / Контент алаңы',
      webservice: 'Веб-сервис / Сайт'
    },
    loginTitle: 'Серіктес кабинетіне кіру',
    registerTitle: 'Серіктесті тіркеу',
    noAccount: 'Тіркелгі жоқ па?',
    hasAccount: 'Тіркелгі бар ма?'
  },
  onboarding: {
    step1: 'Серіктес түрі',
    step2: 'Байланыс',
  ...
  events: {
    title: 'Іс-шаралар каталогы',
    search: 'Іс-шараларды іздеу',
    city: 'Қала',
    category: 'Санат',
  ...
  documents: {
    title: 'Құжаттар',
    legalStatus: 'Заңдық мәртебе',
    legalStatuses: {
      legal_entity: 'Заңды тұлға',
      sole_proprietor: 'Жеке кәсіпкер',
      individual: 'Жеке тұлға'
    },
    docTypes: {
      partnership_agreement: 'Серіктестік шарты',
      partnership_agreement_ip: 'ЖК үшін оферта шарты',
      accession_agreement: 'Қосылу шарты',
      personal_data_consent: 'ДЖ өңдеуге келісім',
      identity_document: 'Жеке басты куәландыратын құжат',
      bank_details: 'Банктік деректемелер',
      registration_certificate: 'ЖК тіркеу куәлігі'
    },
    status: {
      draft: 'Жоба',
      awaiting_partner_signature: 'Серіктес қолына күту',
      under_ticketon_review: 'Ticketon тексеруінде',
      awaiting_ticketon_signature: 'Ticketon қолына күту',
      signed: 'Екі жақтан қол қойылды',
      archived: 'Мұрағат',
      rejected: 'Қабылданбады'
    },
    upload: 'Қол қойылған құжатты жүктеу',
    download: 'Жүктеп алу',
